...
#define INCREASE_ASSIST__PORT		GPIOD			// Uses original UART2 Pins
#define INCREASE_ASSIST__PIN		GPIO_PIN_5		// Uses original UART2 Pins
#define DECREASE_ASSIST__PORT		GPIOD			// Uses original UART2 Pins
#define DECREASE_ASSIST__PIN		GPIO_PIN_6		// Uses original UART2 Pins
